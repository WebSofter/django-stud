# Generated by Django 4.2.9 on 2024-05-23 17:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='content-default.jpg', null=True, upload_to='uploads/')),
                ('type', models.CharField(choices=[('RECIPE', 'Рецепт'), ('VIDEO', 'Видео'), ('MENU', 'Меню'), ('ANALYSIS', 'Анализ')], default='RECIPE', max_length=10)),
